...
const API_URL = process.env.NEXT_PUBLIC_API_URL || '' // Use internal API routes when deployed on Vercel
        ...
        <nav className="flex-shrink-0 relative">
          ...
          <div className="relative flex items-end justify-around h-20 pb-safe px-2">
            ...
            <button
              ...
              className={`tab-item flex flex-col items-center justify-center w-16 pb-2 pt-3 transition-all duration-300 ${activeTab === "map" ? "tab-active" : ""
                }`}
            >
              <Map
            ...
            <button
              ...
              className={`tab-item flex flex-col items-center justify-center w-16 pb-2 pt-3 transition-all duration-300 ${activeTab === "list" ? "tab-active" : ""
                }`}
            >
              <List
            ...
            <button
              ...
              className={`tab-item flex flex-col items-center justify-center w-16 pb-2 pt-3 transition-all duration-300 ${activeTab === "add" ? "tab-active" : ""
                }`}
            >
              <svg
            ...
            <button
              ...
              className={`tab-item flex flex-col items-center justify-center w-16 pb-2 pt-3 transition-all duration-300 ${activeTab === "profile" ? "tab-active" : ""
                }`}
            >
              <User
